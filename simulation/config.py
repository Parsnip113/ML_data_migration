...
# 模拟相关
SIMULATION_TIME = 3600000 * 12 # 模拟总时长 模拟环境单位: ms
...
TRACE_FORMAT = "SYSTOR17" # <<--- 修改这里来选择不同的解析器
...
TIER_CONFIGS = [
    {'name': 'Tier1_Optane', 'capacity_MB': 1024 * 64,  'a_ms': 0.0002, 'b_ms_per_lba': 0.00026, 'num_devices': 1}, # Optane: a=0.2us, b=0.26us/LBA
    {'name': 'Tier2_SSD',    'capacity_MB': 1024 * 512, 'a_ms': 0.06,   'b_ms_per_lba': 0.0005,  'num_devices': 1}, # SSD: a=60us, b=0.5us/LBA
    {'name': 'Tier3_HDD',    'capacity_MB': 524288 * 10, 'a_ms': 4.0,    'b_ms_per_lba': 0.002,   'num_devices': 8}  # HDD: a=4ms, b=2us/LBA. 论文中HDD是8个并行
]
# sys17 32G 512G * 10
...
TOTAL_LBAS_MSR= 1024 * 1024 * 48
TOTAL_LBAS = 1024 * 1024 * 1024 * 10
...
# 追踪文件路径
TRACE_FILE_PATH = "/home/cyrus/PycharmProjects/MLDS/simulation/traces/sys17/2016022208-LUN0.csv" # 您需要准备一个追踪文件
